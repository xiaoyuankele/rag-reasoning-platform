...
执行前冻结 12 个真实问题。语义检索请求 12/12 成功，预期来源 Hit@5 为 11/12；命中的 11 个案例中，
预期文献均排在第 1 名。唯一失败案例的英文目标文献在补充 Top 20 诊断中排第 14，说明当前问题主要是
跨语言相近主题排序，而不是漏向量或 SQL 漏查。
