...
> 状态：实施中；B1～B4 与 B5.1～B5.2 已完成。文档、解析任务、chunks、向量任务创建/查询和关键词检索已接入 Cookie 认证、OwnerScope、Application 与作用域 SQL，并通过双用户真实 HTTP/PostgreSQL 测试；B5 后续仍需隔离语义检索与问答。确认日期：2026-08-16。
