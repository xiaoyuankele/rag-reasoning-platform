...
> 状态：实施中；B1～B5 已完成。文档、解析任务、chunks、向量任务、关键词检索、语义检索和问答已接入 Cookie 认证、OwnerScope、Application 与作用域 SQL，并通过双用户真实 HTTP/PostgreSQL/pgvector 测试；下一步执行 B6 历史数据显式认领。确认日期：2026-08-16。
